...
//   if (normalized.length > 0) {
//     try {
//       const bill = calculateBillPreview(normalized);
//       setOrderTotal(Number(bill.total ?? bill.totalAmount ?? 0));
//       setBillPreview({
//         subtotal: bill.subtotal ?? 0,
//         totalDiscount: bill.totalDiscount ?? 0,
...
//       return { ...it, unitPrice: exact.price, price: exact.price * qty, nameError: null };
//     } else {
...
//       (it.name && it.name.toLowerCase().includes(filterValue.toLowerCase())) ||
...
//         accessorKey: "orderNo",
//         header: "Order ID.",
//         cell: ({ getValue }) => <span className="order-number">{getValue()}</span>,
//         size: 120,
...
//           <div className="no-visible-items"><small>—</small></div>
//         ) : (
...
//   header: "Total (₹)",
//   cell: ({ row }) => <span className="order-total">₹{row.original.totalAmount}</span>,
//   size: 90,
//   enableColumnFilter: true,
//   filterFn: (row, columnId, filterValue) => {
//     if (!filterValue) return true;
...
//                     onClick={() => handleUpdateStatus(order.orderNo, "preparing")}
...
//                     onClick={() => handleUpdateStatus(order.orderNo, "cancelled")}
//                     title="Cancel Order"
//                   >
...
//         const qty = (item && typeof item.quantity !== 'undefined') ? String(item.quantity) : "";
//         if (qty.includes(searchValue)) return true;

//         const price = (item && typeof item.price !== 'undefined') ? String(item.price) : "";
//         if (price.includes(searchValue)) return true;
//       }

//       const total = (typeof original.total !== 'undefined' && original.total !== null) ? String(original.total) : "";
...
//                     />
//                     <label className="form-check-label" htmlFor="showCompletedCancelled">
//                       Show Completed & Cancelled ({stats.completed + stats.cancelled})
//                     </label>
//                   </div>
//                 </div>
//               </div>
...
//                   Orders {showCompletedCancelled ? "(Completed & Cancelled)" : "(Active)"}
//                 </h3>
//               </div>
...
//                     {selectedStatus === "all" ? "All Status" : getStatusDisplayText(selectedStatus)}
//                     <i className="fas fa-chevron-down ms-2"></i>
//                   </button>

//                   <div className="industrial-menu" role="menu" aria-hidden={!filterOpen}>
//                     <button
//                       role="menuitem"
//                       className={`industrial-option ${selectedStatus === "all" ? "selected" : ""}`}
//                       onClick={() => { setSelectedStatus("all"); setFilterOpen(false); }}
//                       type="button"
//                     >
//                       <span>
...
//                     <button
//                       role="menuitem"
//                       className={`industrial-option ${selectedStatus === "placed" ? "selected" : ""}`}
//                       onClick={() => { setSelectedStatus("placed"); setFilterOpen(false); }}
//                       type="button"
//                     >
//                       <span>
//                         <i className=" option-icon" aria-hidden="true"></i>
...
//                     <button
//                       role="menuitem"
//                       className={`industrial-option ${selectedStatus === "preparing" ? "selected" : ""}`}
//                       onClick={() => { setSelectedStatus("preparing"); setFilterOpen(false); }}
//                       type="button"
//                     >
//                       <span>
//                         <i className=" option-icon" aria-hidden="true"></i>
...
//                     <button
//                       role="menuitem"
//                       className={`industrial-option ${selectedStatus === "served" ? "selected" : ""}`}
//                       onClick={() => { setSelectedStatus("served"); setFilterOpen(false); }}
//                       type="button"
//                     >
//                       <span>
//                         <i className="option-icon" aria-hidden="true"></i>
...
//                     <button
//                       role="menuitem"
//                       className={`industrial-option ${selectedStatus === "paid" ? "selected" : ""}`}
//                       onClick={() => { setSelectedStatus("paid"); setFilterOpen(false); }}
//                       type="button"
//                     >
//                       <span>
//                         <i className="option-icon" aria-hidden="true"></i>
...
//                   </div>
//                 </div>
//                 {(globalFilter || selectedStatus !== "all" || showCompletedCancelled || columnFilters.length > 0) && (
//                   <button
...
//                         className={`item-name-input ${item.nameError ? "error" : ""}`}
...
//                             return !editedItems.some((it, i2) => i2 !== index && (it.name || "").toLowerCase() === mLower);
//                           })
//                           .map(m => <option key={m._id} value={m.name} />)}
//                       </datalist>
...
//       disabled={item.status === "cancelled" || item.quantity === 0}
//     >
//       -
//     </button>
